...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full overflow-hidden">
      <motion.div 
        className="w-full pt-24 pb-12 px-6 lg:px-8 relative z-10 bg-gradient-to-br from-secondary-bg/80 via-[color:var(--background)]/90 to-[color:var(--accent)]/20 backdrop-blur-sm rounded-t-3xl shadow-2xl"
        initial="hidden"
        whileInView="visible"
